...
onMounted(() => {
  ...
  scrollTl.fromTo(scrollContent.value, { opacity: 1 }, { opacity: 0 })
    ...
    .from("#jobsList", {opacity:0, translateY: 30}, "-=.25")
})
...
<template>
  <main :data-theme="theme" class="flex justify-center w-full h-[200vh] bg-base-300">
    <div id="mainContainer" class="fixed bg-base-100 max-w-[1080px] m-auto h-full">
      <!-- Shapes -->
